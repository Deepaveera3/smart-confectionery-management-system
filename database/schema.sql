...
-- Complete Database Schema DDL & Seed Data

CREATE DATABASE IF NOT EXISTS `sweet_haven_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `sweet_haven_db`;

-- Disable Foreign Key checks for clean reset during installation if needed
...
-- 1. USERS TABLE (Supports both Customer and Admin roles)
CREATE TABLE `users` (
...
-- 10. DIGITAL LOYALTY ACCOUNTS TABLE
...
CREATE TABLE `notifications` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
  `user_id` INT DEFAULT NULL, -- NULL means broadcast to admin
...
-- 15. INVENTORY & SMART STOCK MANAGEMENT TABLE
...
-- SEED INITIAL DATA
-- Default Admin Account (password: Admin@123 hashed using bcrypt - $2a$10$wOa8bCj5Y0z1B89/F93c4eXgW4xO5Xw1J.5bW9xQpM0l/n9sY5KKS)
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `password`, `role`, `status`) VALUES
(1, 'Sweet Haven Admin', 'admin@sweethaven.com', '+91 9876543210', '$2a$10$wOa8bCj5Y0z1B89/F93c4eXgW4xO5Xw1J.5bW9xQpM0l/n9sY5KKS', 'admin', 'active'),
(2, 'Demo Customer', 'customer@sweethaven.com', '+91 9123456789', '$2a$10$wOa8bCj5Y0z1B89/F93c4eXgW4xO5Xw1J.5bW9xQpM0l/n9sY5KKS', 'customer', 'active');
...
-- Loyalty Account for Demo Customer
